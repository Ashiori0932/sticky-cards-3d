...
- Eight varied, tapered white Three.js impact lines with black outlines rush
  forward from depth and frame the final card without covering its artwork;
  every line rises sharply toward the camera as it extends away from the card.
